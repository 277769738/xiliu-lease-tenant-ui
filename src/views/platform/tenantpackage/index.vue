<template>
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="queryParams" ref="queryForm" size="small" label-width="140px">
          <el-form-item label="套餐名" prop="packageName">
            <el-input v-model="queryParams.packageName" class="input-width" placeholder="请输入套餐名" clearable></el-input>
          </el-form-item>
    ...
    <el-card class="operate-container" shadow="never">
      ...
      <span>数据列表</span>
      <el-button style="margin-left: 20px" type="primary" plain icon="el-icon-circle-plus" size="mini" @click="handleAdd" v-hasPermi="['platform:package:add']">新增</el-button>
      <el-button type="success" plain icon="el-icon-edit-outline" size="mini" :disabled="single" @click="handleUpdate" v-hasPermi="['platform:package:edit']">修改</el-button>
      <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete" v-hasPermi="['platform:package:remove']">删除</el-button>
      <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['platform:package:export']">导出</el-button>
    </el-card>

    <!--数据列表区-->
    <div class="table-container">
      <el-table v-loading="loading" :data="tenantpackageList" @selection-change="handleSelectionChange" border>
        <el-table-column fixed label="序号" min-width="20%"   align="center">
          <template slot-scope="scope">
            <span>{{(queryParams.pageNum-1)*queryParams.pageSize+(scope.$index + 1)}} </span>
          </template>
        </el-table-column>
        <el-table-column label="套餐编号" align="center" prop="packageId" v-if="false"/>
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['platform:package:edit']"
            >修改</el-button>
            <el-button
              size="mini"
              type="text"
              ...
              v-hasPermi="['platform:package:remove']"
            >删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
  import { listTenantpackage, getTenantpackage, delTenantpackage, addTenantpackage, updateTenantpackage } from "@/api/platform/tenantpackage";
